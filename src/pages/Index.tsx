      ...
      <nav className="bg-[#2f3136] border-b border-[#202225] px-4 sm:px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="hidden sm:flex items-center gap-4">
            ...
            <Button onClick={() => navigate("/chat")} className="bg-[#5865f2] hover:bg-[#4752c4] text-white px-6 py-2 rounded text-sm font-medium">
              Начать бесплатно
            </Button>
          </div>
          <Button
          ...
          >
            ...
            <div className="flex-1 p-2">
              ...
              <div>
                ...
                <div className="mt-1 space-y-0.5">
                  {["Общий звонок", "Личная беседа"].map((channel) => (
                    <div
                      key={channel}
                      className="flex items-center gap-1.5 px-2 py-1 rounded text-[#8e9297] hover:text-[#dcddde] hover:bg-[#393c43] cursor-pointer"
                    >
            ...
            <div className="flex-1 p-2 sm:p-4 space-y-4 sm:space-y-6 overflow-y-auto">
              ...
              <div className="flex gap-2 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-baseline gap-2 mb-1">
                    <span className="text-white font-medium text-sm sm:text-base">ЧатОн</span>
                  ...
                  <div className="text-[#dcddde] text-sm sm:text-base">
                    <p className="mb-3 sm:mb-4">
                      <strong>Привет! Добро пожаловать в ЧатОн 👋</strong> Здесь ты можешь переписываться, созваниваться и общаться с друзьями и близкими.
                    </p>
                    <div className="bg-[#2f3136] border-l-4 border-[#5865f2] p-3 sm:p-4 rounded">
                      <h3 className="text-white font-semibold mb-2 text-sm sm:text-base">Что умеет ЧатОн:</h3>
                      <ul className="space-y-1 text-xs sm:text-sm text-[#b9bbbe]">
                        <li>💬 Текстовые чаты и группы</li>
                        <li>📞 Голосовые и видеозвонки</li>
                        <li>📁 Отправка файлов, фото и видео</li>
                        <li>🔒 Шифрование всех сообщений</li>
              ...
              <div className="flex gap-2 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-[#dcddde] mb-3 text-sm sm:text-base">
                    Наконец-то нашла удобный мессенджер! Качество звонков просто отличное 🔥
                  </div>
                  ...
                  <div className="bg-[#2f3136] border border-[#202225] rounded-lg overflow-hidden w-full max-w-sm">
                    <div className="h-16 sm:h-20 bg-gradient-to-r from-[#5865f2] to-[#7c3aed] relative flex items-center justify-center">
                      <div className="text-white text-center">
                        ...
                        <div className="text-xs opacity-80">HD качество · Шифрование</div>
                      </div>
                    </div>
                    <div className="pt-4 sm:pt-5 px-3 sm:px-4 pb-3 sm:pb-4">
                      ...
                      <div>
                        ...
                        <div className="flex items-start gap-2 sm:gap-3 p-2 sm:p-3 bg-[#36393f] rounded-lg">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="text-white font-semibold text-xs sm:text-sm mb-1">Видеозвонок · ЧатОн</div>
                            <div className="text-[#dcddde] text-xs sm:text-sm mb-1">Общий чат</div>
                            <div className="text-[#b9bbbe] text-xs sm:text-sm mb-2">3 участника</div>
                            <div className="flex items-center gap-2">
                              <div className="w-2 h-2 bg-[#3ba55c] rounded-full animate-pulse"></div>
                              <span className="text-[#3ba55c] text-xs font-medium">5:23 идёт</span>
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <div className="flex gap-2 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-[#dcddde] text-sm sm:text-base">
                    Наконец-то нашёл где можно и написать, и позвонить — всё в одном месте!
                  </div>
                </div>
              </div>
              ...
              <div className="bg-[#2f3136] border border-[#202225] rounded-lg p-4 sm:p-6 mt-6 sm:mt-8">
                <h2 className="text-xl sm:text-2xl font-bold text-white mb-4 flex items-center gap-2">
                  <Smile className="w-5 h-5 sm:w-6 sm:h-6 text-[#5865f2]" />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-4 sm:mb-6">
                  <div className="text-center">
                    ...
                    <p className="text-[#b9bbbe] text-xs sm:text-sm">Создай аккаунт за 30 секунд — бесплатно</p>
                  </div>
                  <div className="text-center">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#5865f2] rounded-full flex items-center justify-center mx-auto mb-3">
                    ...
                    <p className="text-[#b9bbbe] text-xs sm:text-sm">Пригласи близких по ссылке или нику</p>
                  </div>
                  <div className="text-center">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#5865f2] rounded-full flex items-center justify-center mx-auto mb-3">
                    ...
                    <p className="text-[#b9bbbe] text-xs sm:text-sm">Пиши, звони, делись файлами — всё сразу</p>
                  </div>
                </div>

                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                  <Button onClick={() => navigate("/chat")} className="bg-[#5865f2] hover:bg-[#4752c4] text-white px-6 sm:px-8 py-2 sm:py-3 rounded text-sm font-medium">
              ...
              <div className="bg-[#2f3136] border border-[#202225] rounded-lg p-4 sm:p-6">
                <h3 className="text-lg sm:text-xl font-bold text-white mb-4">Почему ЧатОн?</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                  {[
                    {
                      icon: <Zap className="w-4 h-4 sm:w-5 sm:h-5" />,
                      title: "Моментальная доставка",
                      desc: "Сообщения приходят мгновенно",
                    },
                    {
                    ...
                    },
                    {
                      ...
                      desc: "Только вы читаете свои сообщения",
                    },
                    {
                      icon: <Shield className="w-4 h-4 sm:w-5 sm:h-5" />,
                      title: "Безопасность",
                      desc: "Никакой рекламы и слежки за данными",
                    },
                  ].map((feature, index) => (
                    <div
                      key={index}
